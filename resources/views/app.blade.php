...
<head>
    ...
    <!-- Основные SEO теги -->
    <title>Benotes - Открытая платформа для заметок и закладок</title>
    <meta name="description" content="Benotes - это бесплатное приложение с открытым исходным кодом для сохранения заметок и закладок в одном месте. Поддерживает Markdown, PWA, самостоятельный хостинг и автоматическое сохранение ссылок с изображениями.">
    ...
    <meta name="author" content="Benotes">
    <meta name="robots" content="index, follow">
    <meta name="language" content="ru">

    <!-- Open Graph теги -->
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Benotes">
    <meta property="og:title" content="Benotes - Открытая платформа для заметок и закладок">
    ...
    <meta property="og:image:alt" content="Логотип Benotes - приложение для заметок и закладок">
    ...
    <meta name="twitter:title" content="Benotes - Открытая платформа для заметок и закладок">
    ...
    <meta name="twitter:image:alt" content="Логотип Benotes">

    <!-- Дополнительные мета теги -->
    <meta name="application-name" content="Benotes">
